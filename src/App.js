...
import BgSvg from "./components/svg/bg.svg";
...
export default function App() {
  ...
  const [rendered, setRendered] = React.useState(
    <MainContent renderCells={renderCells} renderExercises={renderExercises} />
  );
      ...
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          <List>
            ...
            <ListItem button key="exercicio" onClick={() => renderExercises()}>
              <ListItemIcon>
                <Icon>
